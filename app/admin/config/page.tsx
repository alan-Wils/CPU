...
const METRC_AUTH_MODE_LABELS: Record<string, string> = {
  ...
  sandbox_x_metrc_key: "Sandbox — x-metrc-key only",
  sandbox_x_metrc_key_and_user_key_header: "Sandbox — x-metrc-key + x-metrc-user-key",
  ...
  production_x_metrc_key_and_userkey: "Production — x-metrc-key + x-metrc-userkey",
  vendor_only: "Sandbox setup — vendor key only",
