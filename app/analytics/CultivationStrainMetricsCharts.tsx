...
export function CultivationStrainMetricsCharts(props: { from: string; to: string }) {
  const { from, to } = props;
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <h2 style={{ textAlign: "center", marginBottom: 8, fontSize: 22 }}>Cultivation strain metrics</h2>
          <p style={{ textAlign: "center", color: "#94a3b8", marginTop: 0 }}>
            Uses the dashboard date range ({from} → {to}). <strong>Potency</strong> and <strong>dry yield</strong> (g / sq
            ft) from dry flower batches (lab <strong>Test Passed</strong>). <strong>Fresh frozen yield</strong> uses FF
            grams ÷ parent canopy. Hover charts for batch id.
          </p>
