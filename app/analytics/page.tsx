      ...
      <main style={pageStyle}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ textAlign: "center", color: "#94a3b8", marginTop: 0 }}>
            ...
            <strong> Fresh frozen yield</strong> (g / sq ft) uses FF grams (store, relational column, or parsed from the
            amount line) ÷ parent canopy (dry canopy when set, else flower table sq ft × FF plant share). Partial harvests
            included. Stem waste (g / sq ft) is (AI sheet sum − entered grams) ÷ canopy when logged on the FF
