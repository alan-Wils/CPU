...
export function pickCultivationStorageLocationsFromConfigPayload(data: {
  cultivation?: { storageLocations?: unknown };
}): CultivationStorageLocationsConfig {
  return normalizeCultivationStorageLocationsConfig(data?.cultivation?.storageLocations);
}
