...
export function applyMetrcSuccessStatus(
  ...
  if (typeof patch.totalHarvestsSynced === "number") {
    next.metrcSandboxLastHarvestsCount = patch.totalHarvestsSynced;
    next.totalHarvestsSynced = patch.totalHarvestsSynced;
