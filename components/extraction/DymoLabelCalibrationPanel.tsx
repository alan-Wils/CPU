...
import { ARROW_RIGHT, EM_DASH } from "@/lib/textSymbols";
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: "0 0 14px", fontSize: 12, color: "#94a3b8", lineHeight: 1.45 }}>
        ...
        <strong style={{ color: "#e2e8f0" }}>top {ARROW_RIGHT} bottom</strong>: extraction number (e.g. GMO-051226-1), strain blend, then product {EM_DASH}
        all bold; <strong style={{ color: "#e2e8f0" }}>rotation</strong> still turns the{" "}
        <em>whole</em> label if your driver/die needs it. Vertical centering tends to print across two roll stickers {EM_DASH}
        ...
        {" "}
        {ARROW_RIGHT} <code style={{ color: "#a5b4fc" }}>-18px</code>.
      </p>
      <p style={{ margin: "0 0 14px", fontSize: 12, color: "#94a3b8", lineHeight: 1.45 }}>
      ...
      <p style={{ margin: "0 0 12px", fontSize: 11, color: "#64748b", lineHeight: 1.42 }}>
        ...
        <strong style={{ color: "#cbd5e1" }}>More settings {ARROW_RIGHT} Paper size</strong> to your stock,{" "}
